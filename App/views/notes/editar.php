...
<div class="container">
  ...
  <h3 class="light">Editar bloco de comentário</h3>
  ...
  <form action="/notes/editar/<?php echo $data['registros']['id']; ?>" method="post" enctype="multipart/form-data">
    ...
    <?php 
      // verifica se tem a imagem e habilida o botão para deletar a imagem, Se não tiver imagem habilita o botão para upload de imagem
